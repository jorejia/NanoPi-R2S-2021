...
if [ -f /mnt/mmcblk0p2/openwrt-rockchip-armv8-friendlyarm_nanopi-r2s-squashfs-sysupgrade.img.gz	]; then
...
cd /mnt/mmcblk0p2
	pv /mnt/mmcblk0p2/openwrt-rockchip-armv8-friendlyarm_nanopi-r2s-squashfs-sysupgrade.img.gz | gunzip openwrt-rockchip-armv8-friendlyarm_nanopi-r2s-squashfs-sysupgrade.img.gz
	echo -e '\e[92m准备解压镜像文件\e[0m'
rm -rf openwrt-rockchip-armv8-friendlyarm_nanopi-r2s-squashfs-sysupgrade.img.gz
lodev=$(losetup -f)
mkdir /mnt/img
losetup -o 100663296 $lodev /mnt/mmcblk0p2/openwrt-rockchip-armv8-friendlyarm_nanopi-r2s-squashfs-sysupgrade.img
mount $lodev /mnt/img
...
zstdmt /mnt/mmcblk0p2/openwrt-rockchip-armv8-friendlyarm_nanopi-r2s-squashfs-sysupgrade.img -o /tmp/openwrt-rockchip-armv8-friendlyarm_nanopi-r2s-squashfs-sysupgrade.img.zst
...
if [ -f /tmp/openwrt-rockchip-armv8-friendlyarm_nanopi-r2s-squashfs-sysupgrade.img.zst ]; then
	...
	pv /tmp/openwrt-rockchip-armv8-friendlyarm_nanopi-r2s-squashfs-sysupgrade.img.zst | zstdcat | dd of=/dev/mmcblk0 conv=fsync
